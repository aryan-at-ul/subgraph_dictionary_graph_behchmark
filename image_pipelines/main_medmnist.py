...
def parse_arguments():
    ...
    parser.add_argument('--data_flag', type=str, default='chestmnist',
                        choices=['tissuemnist', 'pathmnist', 'chestmnist', 'dermamnist', 'octmnist', 'pneumoniamnist',
...
def train(model, device, train_loader, optimizer, criterion_cls, logger):
    ...
    for images, labels in tqdm(train_loader, desc='Training', leave=False):
        ...
        #quick fix for the issue of the model outputting float32 and the labels being int64
...
def main():
    ...
    log_filename = f'{args.data_flag}_gnn.log'
